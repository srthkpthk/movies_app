...
import 'package:moviesapp/util/Constants.dart';
...
class AppRepository {
  ...
  Future<GenreResponse> getGenres() async {
    var params = {"api_key": Constansts.API_KEY, "language": "en-US"};
    try {
  ...
  Future<PersonResponse> getPersons() async {
    var params = {"api_key": Constansts.API_KEY};
    try {
      Response response =
